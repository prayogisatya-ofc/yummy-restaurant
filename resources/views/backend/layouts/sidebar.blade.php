        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item">
                <span class="nav-link collapsed d-flex justify-content-between align-items-center"
                    data-bs-toggle="collapse" data-bs-target="#submenu-master" aria-expanded="{{ request()->routeIs('panel.menus.*') || request()->routeIs('panel.chefs.*') || request()->routeIs('panel.events.*') ? 'true' : '' }}">
                    <span>
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="multi-level collapse {{ request()->routeIs('panel.menus.*') || request()->routeIs('panel.chefs.*') || request()->routeIs('panel.events.*') ? 'show' : '' }}" role="list" id="submenu-master" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item {{ request()->routeIs('panel.menus.*') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('panel.menus.index') }}">
                                <span class="sidebar-text">Menus</span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->routeIs('panel.chefs.*') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('panel.chefs.index') }}">
                                <span class="sidebar-text">Chefs</span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->routeIs('panel.events.*') ? 'active' : '' }}">
            ...
            <li class="nav-item {{ request()->routeIs('panel.transactions.*') ? 'active' : '' }}">
                <a href="{{ route('panel.transactions.index') }}" class="nav-link">
                    <span class="sidebar-icon">
