            ...
            <table class="table table-centered table-nowrap mb-0 rounded">
                ...
                <tbody>
                    ...
                    <tr class="align-middle">
                        <td><span class="text-primary fw-bold">{{ ($images->currentPage() - 1) * $images->perPage() + $loop->iteration }}</span></td>
                        <td>
                            <img src="{{ asset('storage/' . $item->file) }}" alt="{{ $item->name }}" height="80" class="rounded">
                        </td>
                        <td>{{ $item->name }}</td>
                        <td>{{ $item->slug }}</td>
                        ...
                        <td>
                            ...
                            <form action="{{ route('panel.images.destroy', $item->uuid) }}" hidden method="post" id="delete-image-{{ $item->uuid }}">
                                @csrf
                                @method('DELETE')
                            </form>
                        </td>
