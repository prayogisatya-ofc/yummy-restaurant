...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center sticky-top">
        <div class="container position-relative d-flex align-items-center justify-content-between">
            ...
            <button type="button" class="btn btn-getstarted" data-bs-toggle="modal" data-bs-target="#modalBook">Book a Table</button>
        ...
        <section id="book-a-table" class="book-a-table section">
            ...
            <div class="container">
                ...
                <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 reservation-img" style="background-image: url({{ asset('frontend/img/reservation.jpg') }});">
                    </div>
